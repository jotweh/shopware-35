...
class Enlight_Controller_Router_RouterDefault extends Enlight_Controller_Router_Router
{
	...
	public function route(Zend_Controller_Request_Abstract $request)
	{
		...
		if($event = Enlight()->Events()->notifyUntil('Enlight_Controller_Router_Route', array('subject'=>$this, 'request'=>$request))) {
	    ...
	    $params = Enlight()->Events()->filter('Enlight_Controller_Router_FilterRouteParams', $params);
