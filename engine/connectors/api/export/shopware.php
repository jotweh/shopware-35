...
class sShopwareExport
{
	 ...
	 * Zugeordnete Downloads, Links, Verknüpfungen, Cross-Selling
	 ...
	 *  
	 * @access public
	 * @return array Array mit Ergebnisdatensätzen
	 */
	...
	/**
	 * Gibt ein Array mit allen offenen Bestellungen zurück
	 * @access public
	...
	/**
	 * Ändert den Status ein oder mehrerer Bestellungen
	 * @param array $order
	 ...
	 * @access public
	 * @return bool gibt bei Erfolg true zurück
	 */
	...
	/**
	 * Rückgabe der Bestelldetails (Artikel) zu einer oder mehreren Bestellungen
	 * @param array $order
	 *   - [orderID] BestellID oder
	 *   - [orderIDs] mehrere IDs in Form eines Arrays
	 *   - [where] eine SQL.Bedingung z.b. "status=0 OR status=1"
	 * @access public
	 * @return array|bool Gibt bei Erfolg die Bestellpositionen und bei einem Fehler false zurück
	 */
	 ...
	 * Der Kunde mit der ID $userID erhält die Kundennummer $customernumber
	 ...
	 * @access public
	 * @return bool Gibt bei Erfolg true und bei einem Fehler false zurück
	 */
	...
	/**
	 * Gibt alle Kategorien zurück, die unterhalb von $parentID liegen, falls $parentID nicht übergeben wird
	 * werden automatisch der gesamte Kategoriebaum exportiert
	 * @param array $categorie_mask Optional. Hier können Sie bestimmen, wie die Felder im Export benannt werden sollen
	 * @param int $parentID Optional. Definiert von welchem Zweig aus die Kategorien zurückgegeben werden sollen
	 * @access public
	 * @return array Gibt die Kategorien in einer Baumstruktur zurück
	 */
	...
	/**
	 * Hierüber können Sie ID der letzten Bestellung abfragen
	 * @access public
	...
	/**
	 * Export aller Shopware Einstellungen für den Import / Abgleich in die Warenwirtschaft
	 * Exportiert:
	 * 
	 * [result][tax] = Shopware MwSt. - Sätze (aus s_core_tax)
	 * 
	 * [result][order_states] = Shopware Bestell-Stati (aus s_core_states)
	 * 
	 * [result][payment_states] = Shopware Zahl-Stati (aus s_core_states)
	 * 
	 * [result][units] = Shopware Preiseinheiten (Stück/Liter etc.) (aus s_core_units)
	 * 
