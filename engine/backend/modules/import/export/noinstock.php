...
$sql = "
	...
	WHERE IFNULL(v.instock,d.instock) <= 0
...
if($_REQUEST["formatID"]==1)
{
	...
	header('Content-Disposition: attachment; filename="noinstock.csv"');
...
elseif($_REQUEST["formatID"]==2)
{
	...
	header('Content-Disposition: attachment; filename="noinstock.xml"');
