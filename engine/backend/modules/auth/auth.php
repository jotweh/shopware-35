...
<script type="text/javascript">
	...
	init : function(){
		...
		id:'feed-tree',
		region:'west',
		title:'<?php echo $sLang["auth"]["auth_user"] ?>',
		split:true,
		width: 225,
		minSize: 175,
		maxSize: 400,
		...
		rootVisible:true,
		lines:false,
		loader: new Ext.tree.TreeLoader({dataUrl:'../../../backend/ajax/getAuth.php'}),
		autoScroll:true,
	    ...
	    tree.on('click', function(e){
	    	if (e.attributes.id){
			 ...
			 var url = "auth_new.php?edit="+e.attributes.id;
