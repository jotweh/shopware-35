...
<html>
<head>
  <title><?php echo $sLang["promotion"]["promotion_articles_overview"] ?></title>
	...
	tree = new Tree.TreePanel({
			        ...
			        animate:false, 
			        collapsible: true,
			        title:'<?php echo $sLang["promotion"]["promotion_Categories"] ?>',
			        width: 200,
			        height:'100%',
			        margins:'0 0 0 0',
			        minSize: 175,
	...
	var root = new Tree.AsyncTreeNode({
		 text: '<?php echo $sLang["promotion"]["promotion_shopware"] ?>',
		 draggable:true,
		 id:'0',
		 direct:''
	});
	...
	var iframe = new Ext.ux.IFrameComponent({ 
		...
		animate:true, 
		fitToFrame: true,
		title:'<?php echo $sLang["promotion"]["promotion_options"] ?>',
		width:700,
        height:500,
		collapsible: true,
		id: "myiframe", 
	...
	tree.on('click', function(e){
		 var url = "promotion_inline.php?id="+e.attributes.id;
