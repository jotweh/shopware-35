...
var monthArrayLong = new Array('Januar', 'Februar', 'M‰rz', 'April', 'Mai', 'Juni', 'Juli', 'August', 'September', 'Oktober', 'November', 'Dezember');
...
function refreshDatePicker(dateFieldName, year, month, day)
{
  ...
  var today = new Date();
  var todayString = "Heute ist " + dayArrayMed[today.getDay()] + ", " + monthArrayMed[today.getMonth()] + " " + today.getDate();
  html += TR_todaybutton + TD_todaybutton;
  html += "<button class='dpTodayButton' onClick='refreshDatePicker(\"" + dateFieldName + "\");'>dieser Monat</button> ";
  html += "<button class='dpTodayButton' onClick='updateDateField(\"" + dateFieldName + "\");'>schlieﬂen</button>";
  html += xTD + xTR;
