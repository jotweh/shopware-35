...
<head>
  <title>User-List</title>
    ...
    deleteVotes: function(){
    	Ext.MessageBox.confirm('Bestätigung', 'Sollen die markierten Bewertungen wirklich gelöscht werden?', function deleteClientConfirmed(btn){
   ...
   var limitArray = [['25'],['50'],['100'],['250'],['500']];
    ...
    var pager = new Ext.PagingToolbar({
        ...
        ,
			new Ext.Button  ( {
            	text: 'Markierte Bewertungen löschen',
