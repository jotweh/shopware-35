...
//<![CDATA[
	var _gaq = _gaq || [];
	_gaq.push(['_setAccount', "{$sConfig.sGOOGLECODE|escape:'javascript'}"]);
	_gaq.push(['_trackPageview']);
{if $ordernumber}
{assign var="sOrderNumber" value=$ordernumber}
{/if}
{if $sBasketAfterOrder.content && $sOrderNumber}
{if $sAmountWithTax}
...
{foreach from=$sBasketAfterOrder.content item=sBasketItem}
