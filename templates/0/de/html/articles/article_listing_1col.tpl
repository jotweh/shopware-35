...
<div style="margin-top:10px;">
	...
	{$sSupplierInfo.name}
	{/if} 
	<a href="{$sSupplierInfo.link}" title="{* sSnippet: show all manufacturers *}{$sConfig.sSnippets.sArticleallmanufacturers}" class="bt_allsupplier">{* sSnippet: show all manufacturers *}{$sConfig.sSnippets.sArticleallmanufacturers}</a>
	</div>
...
{else}
	{foreach from=$sArticles item=article key=key name="counter"}
		{include file="articles/article_box_1col.tpl" sArticle=$article key=$key}
	{/foreach}
{/if}
