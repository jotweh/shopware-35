...
<!--BANNER-->
            ...
            <div style="text-align:center; margin-bottom:20px;">
                <a target="_blank" href="{eval var=$sCampaignContainer.data.link}">
...
<!--TEXT-->
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="0" style="margin-bottom:20px;">
                ...
                <h2 style="color:#770D30; line-height:20px; font-size:16px; font-weight:bold; padding:10px 0px 0px 30px; margin:0px;">{eval var=$sCampaignContainer.description}</h2>
	                {if $sCampaignContainer.data.image}
	                	<table width="100%" border="0" cellpadding="0" cellspacing="0" style="margin-bottom:20px;">
	                	<tr>
	                	{if $sCampaignContainer.data.alignment=="left"}
	                	<td>
	                	 <a target="_blank" href="{eval var=$sCampaignContainer.data.link}"><br />
						 <img src="{$sCampaignContainer.data.image}" alt="Banner" border="0" align="middle" />
						 </a>
	                	</td>
	                	{/if}
	                	<td>
	                	<div style=" padding:0 30px 20px  30px; color:#333; line-height:17px; font-size:11px;">{eval var=$sCampaignContainer.data.html} </div>
	                	</td>
   	        ...
   	        <table width="100%" border="0" cellpadding="0" cellspacing="0" style="margin-bottom:20px;">
				<tr>
				  <td style="padding:5px 5px 10px 5px;">
                        <h2 style="color:#666666; font-size:11px; font-weight:bold; margin:10px 0 10px 30px;">{eval var=$sCampaignContainer.description}</h2>
                    <ul style="font-size:13px;font-weight:bold;list-style-position:inside;list-style-type:none; list-style-image:none;">
                                    {foreach from=$sCampaignContainer.data item=sLink}
                                        <li><img src="images/blue_arrow.gif" width="14" height="8" />&nbsp;<a target="_blank" href="{eval var=$sLink.link}" style="text-decoration:none; color:#666666; font-size:11px;">{eval var=$sLink.description}
                                        </a>                                        </li>
                                    {/foreach}
                    </ul>	
				  </td>
                                      ...
                                      <tr>
                                             <td height="30" colspan="2" valign="top" style="padding:10px 0 0 0;">
                                                    <div align="center" style="height:100px; overflow:hidden;">
                                                        ...
                                                        {else}
                                                        <img src="http://{$sConfig.sBASEPATH}/templates/0/de/media/img/de/layout/no_picture.jpg" alt="Kein Bild vorhanden" border="0" />{/if}
                                                        </a>
                                                    </div>
...
<table width="612" border="0" align="center" cellpadding="6" cellspacing="0" bordercolor="#FFFFFF" bgcolor="#FFFFFF" >
  ...
  <tr>
    ...
    <a href="{$sBasefile}?sViewport=newsletter" target="_blank" style="font-size:10px;">{$sConfig.sSnippets.sCampaignsUnsubscribe}</a><br />
    <a href="{$sStart|dirname}/engine/core/php/campaigns.php?campaign={$sCampaign.id}&mailaddress={$sUser.mailaddressID}&hash={$sCampaignHash}" target="_blank" style="font-size:10px;">Newsletter im Browser öffnen</a>
    </td>
  </tr>
</table>    
