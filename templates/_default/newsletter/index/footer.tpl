<table width="560"  border="0" cellspacing="0" cellpadding="0" style="color:#8c8c8c;width:560px; height:50px";>
  <tr>
	...
	<div style="font-size:12px; text-align:left; color:#8c8c8c; padding:8px 0 0 0;margin-top:10px;line-height:14px;">
	...
	<tr>
	<td style="font-size:12px; text-align:left; color:#8c8c8c;margin:0;padding:0;">	<div style="border-bottom:1px solid #C6C6C6; height:6px;line-height:6px;padding:0;margin:0;">&nbsp;</div>	      
</td>
	</tr>
	    
	<tr>
	<td style="font-size:12px; text-align:left; color:#8c8c8c;margin:0;padding:0;padding-top:10px;">
...
<br/>
<table width="560" height="30" border="0" cellspacing="0" cellpadding="0" style="background-color:#fff;line-height:14px; font-size:12px; color:#8c8c8c !important;">
  <tr>
    <td width="20" style="font-size:12px;margin:0;padding:0;padding-left:10px;">&rArr;&nbsp;</td>
    <td style="font-size:12px;margin:0;padding:0;">
  ...
  <tr>
    <td width="20" style="font-size:12px;margin:0;padding:0;padding-left:10px;">&rArr;&nbsp;</td>
    <td style="font-size:12px;margin:0;padding:0;">
    	<a href="{$sStart|dirname}/engine/core/php/campaigns.php?campaign={$sCampaign.id}&mailaddress={$sUser.mailaddressID}&hash={$sCampaignHash}" target="_blank" style="color:#000 !important;">
