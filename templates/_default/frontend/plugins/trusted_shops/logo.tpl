<div id="trustedShopsLogo">
	<div class="inner_container">
		<a href="https://www.trustedshops.com/shop/certificate.php?shop_id={$this->config('TSID')}" title="{s name='WidgetsTrustedLogo'}{/s}" target="_blank">
