<div id="left" class="grid_4 first info">
	...
	<div class="billing_address">
		<div class="inner_container">
			...
			<a href="{$this->url(['controller'=>'account', 'action'=>'billing', 'sTarget'=>'checkout'])}" class="button-middle small">
				{s name="ConfirmLinkChangeBilling"}{/s}
			</a>
			<a href="{$this->url(['controller'=>'account', 'action'=>'selectBilling', 'sTarget'=>'checkout'])}" class="button-middle small">
	...
	<div class="shipping_address">
		<div class="inner_container">
			...
			<a href="{$this->url(['controller'=>'account', 'action'=>'shipping', 'sTarget'=>'checkout'])}" class="button-middle small">
				{s name="ConfirmLinkChangeShipping"}{/s}
			</a>
			
			<a href="{$this->url(['controller'=>'account', 'action'=>'selectShipping', 'sTarget'=>'checkout'])}" class="button-middle small">
