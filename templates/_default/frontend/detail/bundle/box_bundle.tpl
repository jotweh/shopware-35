			...
			{if $bundle.sBundleArticles}
				...
				<form method="get" action="{url controller='checkout' action='addBundle'}">
					...
					<div id='bundleset_{$bundle.id}' class="bundleset">
						...
						{* Main article *}
						{if $this->config('ShowBundleMainArticle')}
						...
						<div class="price_container">
							...
							<div class="price">
								...
								<span id='price_bundle_{$bundle.id}'></span> {$this->config('CURRENCYHTML')} {s name="Star" namespace="frontend/listing/box_article"}{/s}
							</div>
							...
							<div class="discount">
								...
								<span id='price_rabAbs_{$bundle.id}'></span> {$this->config('CURRENCYHTML')} {s name="Star" namespace="frontend/listing/box_article"}{/s} - <span id='price_rabPro_{$bundle.id}'></span>
